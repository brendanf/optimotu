...
```{r setup_co, include=FALSE}
knitr::opts_chunk$set(echo = FALSE)
library(ggplot2)
library(ggtree)
```

(ref:cluster-optimization) OptimOTU threshold optimization procedure.
...
```{r cluster-optimization, fig.cap="(ref:cluster-optimization)", fig.width = 8, fig.height = 5}
library(ggplot2)
library(ggtree)
